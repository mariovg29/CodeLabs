...
class DogCardAdapter(
    ...
    class DogCardViewHolder(view: View?): RecyclerView.ViewHolder(view!!) {
       ...
       val image : ImageView = view!!.findViewById(R.id.image_view)
        val names : TextView = view!!.findViewById(R.id.text_view_name)
        val ages : TextView = view!!.findViewById(R.id.text_view_age)
        val hobbies : TextView = view!!.findViewById(R.id.text_view_hobbies)
    }
